...
public class ExcelSmokeTest {
    ...
    public static void main(String[] args) {
        ...
        List<CollectionInfo> cols = intro.getCollections(
                ...
                java.util.Collections.emptySet(), java.util.Arrays.asList(excelPath), wb);
        ...
        for (CollectionInfo c : excel) {
            ...
            try {
                List<FieldMetadata> fm = intro.describeCollection(null, siteId, name, wb);
                ...
                SharePointComputeTask task = new SharePointComputeTask(
                        null, siteId, name, fields, types, intro, 1000, null, wb);
